...
public static class DbInitializer
{
    public static async Task SeedData(AppDBContext context, ILogger logger)
    {
        ...
        try
        {
            ...
            {
                logger.LogInformation("Activities already exist in the database. Skipping seed.");
                return;
            }
            ...
            logger.LogInformation("Seeded {Count} activities into the database.", activities.Count);
        }
        catch (Exception ex)
        {
